...
class Report {
    ...
    createReportString(){
        ...
        //Table Data ---------------------
            ...
            // (1)   html row components <---- used for column names aswell not just data rows
        ...
        // </div>
            ...
            // (2) year splitter    <--- happens at annual increments
        ...
        // </div>
            ...
            // (3) end table data    <----- append to the end of the table does Adjustment ammount and final figures
        ...
        //TableData Code
            // Now to dynamically genereate our html code based on our template
...
// =====================================================
    ...
    const createPDF = async (html) => {   // you can not change the html recieved var name
        Print.Orientation = "portrait"
        try {
            const { uri } = await Print.printToFileAsync({ html });  //create a pdf file amd adds it to cache
    
            console.log("uri cache: " + uri)
    
            let f = FileSystem.documentDirectory + "ReportRight.pdf"
            console.log("uri files: " + f)
    
            FileSystem.copyAsync({from:uri, to:f})
      ...
      const htmlToPdf = () => {
        ...
        //Print Libary
        // createPDF(htmlTestString)
        createPDF(props.reportStr)
